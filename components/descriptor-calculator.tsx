        ...
        <div className="space-y-6 mt-0">
          ...
          <Tabs defaultValue="calculate" className="w-full">
            <TabsList className="grid w-full grid-cols-2 bg-gray-100 dark:bg-gray-700">
              <TabsTrigger value="calculate" className="text-gray-700 dark:text-gray-200">
                Calculate Descriptors
              </TabsTrigger>
              <TabsTrigger value="filter" className="text-gray-700 dark:text-gray-200">
                Filter
              </TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="calculate">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div className="space-y-2">
                  <Label htmlFor="descriptor-type" className="text-lg font-medium text-gray-700 dark:text-gray-200">
                    Descriptor Type
                  </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="calculation-method" className="text-lg font-medium text-gray-700 dark:text-gray-200">
                    Calculation Method
                  </Label>
            ...
            <TabsContent value="filter">
              <div className="grid grid-cols-1 md:grid-cols-1 gap-4 mt-4">
                <div className="space-y-2">
                  <Label htmlFor="filter-option" className="text-lg font-medium text-gray-700 dark:text-gray-200">
                    Filter Option
                  </Label>
